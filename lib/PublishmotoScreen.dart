...
class PublishMotoScreen extends StatefulWidget {
  @override
  _PublishMotoScreenState createState() => _PublishMotoScreenState();
}

class _PublishMotoScreenState extends State<PublishMotoScreen> {
  ...
  Future<void> _publishMoto() async {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Moto publicada con éxito')),
          );
          Navigator.pop(context);
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Error al publicar la moto')),
          );
        }
      } catch (e) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Publicar Moto', style: TextStyle(color: Colors.orange)),
                  ...
                  GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      child: _imageUrl == null
                          ? Icon(Icons.motorcycle, size: 50, color: Colors.white)
                          : null,
                    ),
                  ),
                  SizedBox(height: 30),
